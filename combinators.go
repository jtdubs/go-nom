...
func Expect[C comparable](want C) ParseFn[C, C] {
	return func(_ context.Context, start Cursor[C]) (Cursor[C], C, error) {
		if start.EOF() {
...
func Map[C comparable, T, U any](p ParseFn[C, T], fn func(T) U) ParseFn[C, U] {
	return func(ctx context.Context, start Cursor[C]) (Cursor[C], U, error) {
		end, result, err := p(ctx, start)
		if err != nil {
...
func Success[C comparable, T any](val T) ParseFn[C, T] {
	return func(_ context.Context, start Cursor[C]) (Cursor[C], T, error) {
...
func Recognize[C comparable, T any](p ParseFn[C, T]) ParseFn[C, []C] {
	return func(ctx context.Context, start Cursor[C]) (Cursor[C], []C, error) {
		end, _, err := p(ctx, start)
		if err != nil {
...
func Bind[C comparable, T any](place *T, p ParseFn[C, T]) ParseFn[C, struct{}] {
	return func(ctx context.Context, start Cursor[C]) (Cursor[C], struct{}, error) {
		end, res, err := p(ctx, start)
		if err != nil {
...
func Second[C comparable, T, U any](p ParseFn[C, Tuple[T, U]]) ParseFn[C, U] {
	return Map(p, func(t Tuple[T, U]) U { return t.B })
}

func Spanning[C comparable, T any](p ParseFn[C, T]) ParseFn[C, Span[C]] {
	return func(ctx context.Context, start Cursor[C]) (end Cursor[C], res Span[C], err error) {
		res.Start = start
		end, _, err = p(ctx, start)
		res.End = end
		return
