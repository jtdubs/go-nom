...
func TestOctDigit0(t *testing.T) {
	p := OctDigit0()
	validate(t, "OctDigit0(%q)", p, "123 hello", 3, "123", false)
	validate(t, "OctDigit0(%q)", p, "18", 1, "1", false)
	validate(t, "OctDigit0(%q)", p, "jello", 0, "", false)
	validate(t, "OctDigit0(%q)", p, "", 0, "", false)
}

func TestOctDigit1(t *testing.T) {
	p := OctDigit1()
	validate(t, "OctDigit1(%q)", p, "123 hello", 3, "123", false)
	validate(t, "OctDigit1(%q)", p, "18", 1, "1", false)
	validate(t, "OctDigit1(%q)", p, "jello", 0, "", true)
	validate(t, "OctDigit1(%q)", p, "", 0, "", true)
}
