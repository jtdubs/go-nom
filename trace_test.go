...
func testParseWord(c Cursor[rune]) (Cursor[rune], []rune, error) {
	return Trace(Many1(testParseChar))(c)
}

func testParseChar(c Cursor[rune]) (Cursor[rune], rune, error) {
	return Trace(Satisfy(func(r rune) bool { return r >= '0' && r <= '9' }))(c)
}
